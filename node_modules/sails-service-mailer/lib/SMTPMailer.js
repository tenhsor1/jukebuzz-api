...
var SMTPMailer = (function (_BaseMailer) {
  _inherits(SMTPMailer, _BaseMailer);
  ...
  function SMTPMailer() {
    ...
    _get(Object.getPrototypeOf(SMTPMailer.prototype), 'constructor', this).apply(this, args);

    this.setProvider(_nodemailer2['default'].createTransport((0, _nodemailerSmtpTransport2['default'])(this.get('provider'))));
  }
