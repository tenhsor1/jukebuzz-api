...
var SendMailMailer = (function (_BaseMailer) {
  _inherits(SendMailMailer, _BaseMailer);

  function SendMailMailer() {
    _classCallCheck(this, SendMailMailer);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _get(Object.getPrototypeOf(SendMailMailer.prototype), 'constructor', this).apply(this, args);

    this.setProvider(_nodemailer2['default'].createTransport((0, _nodemailerSendmailTransport2['default'])(this.get('provider'))));
  }
  ...
  _createClass(SendMailMailer, [{
    ...
    value: function send(_config) {
      ...
      return new Promise(function (resolve, reject) {
        _this.getProvider().sendMail(config, function (error, result) {
...
exports['default'] = SendMailMailer;
