...
var SESMailer = (function (_BaseMailer) {
  _inherits(SESMailer, _BaseMailer);

  function SESMailer() {
    _classCallCheck(this, SESMailer);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _get(Object.getPrototypeOf(SESMailer.prototype), 'constructor', this).apply(this, args);

    this.setProvider(_nodemailer2['default'].createTransport((0, _nodemailerSesTransport2['default'])(this.get('provider'))));
  }
