...
var StubMailer = (function (_BaseMailer) {
  _inherits(StubMailer, _BaseMailer);

  function StubMailer() {
    _classCallCheck(this, StubMailer);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _get(Object.getPrototypeOf(StubMailer.prototype), 'constructor', this).apply(this, args);

    this.setProvider(_nodemailer2['default'].createTransport((0, _nodemailerStubTransport2['default'])(this.get('provider'))));
  }
