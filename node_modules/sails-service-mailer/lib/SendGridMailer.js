...
var SendGridMailer = (function (_BaseMailer) {
  _inherits(SendGridMailer, _BaseMailer);

  function SendGridMailer() {
    _classCallCheck(this, SendGridMailer);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _get(Object.getPrototypeOf(SendGridMailer.prototype), 'constructor', this).apply(this, args);

    this.setProvider(_nodemailer2['default'].createTransport((0, _nodemailerSendgridTransport2['default'])(this.get('provider'))));
  }
...
exports['default'] = SendGridMailer;
