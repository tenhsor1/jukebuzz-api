...
var OpenStreetMapLocation = (function (_BaseLocation) {
  ...
  function OpenStreetMapLocation() {
    ...
    _get(Object.getPrototypeOf(OpenStreetMapLocation.prototype), 'constructor', this).apply(this, args);

    this.setProvider((0, _nodeGeocoder2['default'])('openstreetmap', 'http', this.get()));
  }
