...
var FreeGeoIpLocation = (function (_BaseLocation) {
  ...
  function FreeGeoIpLocation() {
    ...
    _get(Object.getPrototypeOf(FreeGeoIpLocation.prototype), 'constructor', this).apply(this, args);

    this.setProvider((0, _nodeGeocoder2['default'])('freegeoip', 'http', this.get()));
  }
