...
var DataScienceToolkitLocation = (function (_BaseLocation) {
  ...
  function DataScienceToolkitLocation() {
    ...
    _get(Object.getPrototypeOf(DataScienceToolkitLocation.prototype), 'constructor', this).apply(this, args);

    this.setProvider((0, _nodeGeocoder2['default'])('datasciencetoolkit', 'http', this.get()));
  }
