...
var SmartyStreetsLocation = (function (_BaseLocation) {
  ...
  function SmartyStreetsLocation() {
    ...
    _get(Object.getPrototypeOf(SmartyStreetsLocation.prototype), 'constructor', this).apply(this, args);

    this.setProvider((0, _nodeGeocoder2['default'])('smartystreets', 'http', this.get()));
  }
