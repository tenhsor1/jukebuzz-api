...
var GeoCodioLocation = (function (_BaseLocation) {
  ...
  function GeoCodioLocation() {
    ...
    _get(Object.getPrototypeOf(GeoCodioLocation.prototype), 'constructor', this).apply(this, args);

    this.setProvider((0, _nodeGeocoder2['default'])('geocodio', 'http', this.get()));
  }
