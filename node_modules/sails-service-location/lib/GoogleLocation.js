...
var GoogleLocation = (function (_BaseLocation) {
  ...
  function GoogleLocation() {
    ...
    _get(Object.getPrototypeOf(GoogleLocation.prototype), 'constructor', this).apply(this, args);

    this.setProvider((0, _nodeGeocoder2['default'])('google', this.get('apiKey') ? 'https' : 'http', this.get()));
  }
