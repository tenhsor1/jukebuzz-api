...
var NominatimMapQuestLocation = (function (_BaseLocation) {
  ...
  function NominatimMapQuestLocation() {
    ...
    _get(Object.getPrototypeOf(NominatimMapQuestLocation.prototype), 'constructor', this).apply(this, args);

    this.setProvider((0, _nodeGeocoder2['default'])('nominatimmapquest', 'http', this.get()));
  }
