...
var OpenCageLocation = (function (_BaseLocation) {
  ...
  function OpenCageLocation() {
    ...
    _get(Object.getPrototypeOf(OpenCageLocation.prototype), 'constructor', this).apply(this, args);

    this.setProvider((0, _nodeGeocoder2['default'])('opencage', 'http', this.get()));
  }
