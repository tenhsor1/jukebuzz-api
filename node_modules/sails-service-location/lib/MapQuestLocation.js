...
var MapQuestLocation = (function (_BaseLocation) {
  ...
  function MapQuestLocation() {
    ...
    _get(Object.getPrototypeOf(MapQuestLocation.prototype), 'constructor', this).apply(this, args);

    this.setProvider((0, _nodeGeocoder2['default'])('mapquest', 'http', this.get()));
  }
